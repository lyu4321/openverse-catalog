...
def test_process_item_batch_handles_example_batch():
    ...
    with patch.object(
        ...
        expected_call_args = {
            ...
            'license_info': LicenseInfo(license='by', version='3.0',
                                        url='https://creativecommons.org/licenses/by/3.0/',
                                        raw_url='http://creativecommons.org/licenses/by/3.0/'),
            'meta_data': {'description': 'A disinterested noise in a somewhat low tone.',
...
def test_extract_audio_data_handles_example_dict():
    ...
    expected_audio_info = {
        'alt_files': [
            {'bit_rate': 1381, 'filesize': 107592,
             'format': 'wav', 'sample_rate': 44100.0,
             'url': 'https://freesound.org/apiv2/sounds/415362/download/'},
            {'format': 'ogg',
             'url': f'{preview_url_base}/415362_6044691-lq.ogg'},
            {'format': 'mp3',
             'url': f'{preview_url_base}/415362_6044691-lq.mp3'},
            {'format': 'ogg',
             'url': f'{preview_url_base}/415362_6044691-hq.ogg'},
            {'format': 'mp3',
             'url': f'{preview_url_base}/415362_6044691-hq.mp3'}],
        'audio_set': 'https://freesound.org/apiv2/packs/23434/',
        'audio_url': 'https://freesound.org/people/owly-bee/sounds/415362/',
        'bit_rate': 1381,
        'category': 'sound',
        ...
        'foreign_identifier': 415362,
        'foreign_landing_url':
            'https://freesound.org/people/owly-bee/sounds/415362/',
        'license_info': LicenseInfo(
            license='by', version='3.0',
            url='https://creativecommons.org/licenses/by/3.0/',
            raw_url='http://creativecommons.org/licenses/by/3.0/'),
        'meta_data': {
